    ...
    <div>
      ...
      <div className="flex justify-between items-center flex-col gap-4">
        ...
        <button
          ...
          className="w-full py-2.5 bg-green-500 rounded-lg p-2 text-white font-semibold"
        >
          Confirm
        </button>
        <button
          ...
          className="w-full py-2.5 bg-gray-400 rounded-lg p-2 text-white font-semibold"
        >
          Ignore
        </button>
      </div>
...
export default RidePopupCaptain;
